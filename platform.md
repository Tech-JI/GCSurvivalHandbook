...
**Writing Center** 是由学院人文教授带领高年级本科学生组成的写作辅导团队，旨在帮助同学们提升英语学术写作能力。**Writing Center 提供的帮助并不仅限于 ENGL1000/2000 的课程作业**——无论是**个人陈述（Personal Statement）**、**简历（Resume）**、**目的陈述（Statement of Purpose）**，还是其他学术或申请类文书，都可以预约 consultant 进行一对一的辅导。

**秋季英语写作课**期间，教授或助教会带领大家首次了解**Writing Center**的使用方式。每学期末的考试周前，Writing Center 也会为有需要的同学安排预约。

对于新生来说，大一写作课与高中英语写作在形式、主题和习惯上都有很大不同。Writing Center 的 consultants 都经过专业培训，对新生常见的写作问题非常熟悉，且咨询过程完全保密，不用担心信息泄露。在交流中越主动，收获越多，consultants 会引导你更积极地参与对话，不必有心理压力。

**预约方式**：
- 登录网站 [https://bluetiger.sjtu.edu.cn](https://bluetiger.sjtu.edu.cn/)，查看各时段值班同学信息，选择合适时间预约
- 每次预约通常为 **30 分钟** 的面对面交流

也可通过 **飞书** 联系 consultant 将需修改的文章提前发送，以便高效完成辅导。
...
**链接：[https://www.lib.sjtu.edu.cn](https://www.lib.sjtu.edu.cn)**

交大图书馆（主图、包玉刚图书馆、李政道图书馆等）借阅规则如下：
- **借阅期限**：一般图书借期 30 天，可续借一次（再延 30 天）
- **续借与预约**：通过图书馆网站在线办理续借和预约，预约书到架后保留 1 周
- **逾期费**：普通逾期 0.10 元/天/本；如该书被他人预约，逾期费升至 1.00 元/天/本
- **借阅方式**：凭校园卡、思源码或交大 V 卡在自助借还机或服务台办理
- **座位管理**：暂离座位需在座位上注明离开时间（不超过 30 分钟），超时视为自动放弃座位
- **毕业前**：须还清所有借书并结清欠款

## **关于 URL 更新：JI → GC**

学院已由原"密西根学院（JI）"全面升级为"**上海交通大学浦江国际学院（Global College, GC）**"。原 `ji.sjtu.edu.cn` 域名已停用，所有服务均已迁移至 `*.gc.sjtu.edu.cn` 域名下。本手册中所有旧域名链接均已更新，如你发现仍存在 `ji.` 链接，请以 `gc.` 版本为准。
